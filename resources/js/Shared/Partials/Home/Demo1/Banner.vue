    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-sm-6 mb-4">
          <div
            class="
              banner banner-3 banner-fixed banner-radius
              content-middle
              appear-animate
            "
          ...
          >
            <figure>
              <img
                src="images/demos/demo1/banners/banner1.jpg"
                alt="banner"
                width="380"
                height="207"
        ...
        <div class="col-lg-4 col-sm-6 mb-4 order-lg-auto order-sm-last">
          <div
            class="
              banner banner-4 banner-fixed banner-radius
              content-middle content-center
              appear-animate
            "
          ...
          >
            <figure>
              <img
                src="images/demos/demo1/banners/banner2.jpg"
                alt="banner"
                width="350"
                height="177"
            ...
            <div
              class="banner-content d-flex align-items-center w-100 text-left"
            >
              <div class="mr-auto mb-4 mb-md-0">
                ...
                <h3
                  class="banner-title text-primary font-weight-bold lh-1 mb-0"
                >
                  Sale
                </h3>
              </div>
        ...
        <div class="col-lg-4 col-sm-6 mb-4">
          <div
            class="
              banner banner-5 banner-fixed banner-radius
              content-middle
              appear-animate
            "
          ...
          >
            <figure>
              <img
                src="images/demos/demo1/banners/banner3.jpg"
                alt="banner"
                width="380"
                height="207"
